...
test11 = parse expr "1 + 2 * 3"	
test12 = parse expr "(1 + 2) * 3"
test13 = parse expr "-4 + 5 * 6"
test14 = parse expr "10 / 2 + 3"
...
test21 = parse eexpr "1 + 2 * 3"	
test22 = parse eexpr "(1 + 2) * 3"
test23 = parse eexpr "-4 + 5 * 6"
test24 = parse eexpr "10 / 2 + 3abc"